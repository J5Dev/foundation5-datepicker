 ...
 * Copyright 2014 Wilson Júnior, wilsonpjuunior@gmail.com, @wpjunior
...
!function ($) {
    ...
    var Datepicker = function (element, options) {
        ...
        if (this.isRTL) {
            ...
            this.picker.find('.prev i, .next i')
                .toggleClass('foundicon-left-arrow foundicon-right-arrow').toggleClass('foundicon-left-arrow foundicon-right-arrow');
        }
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
        '<tr>' +
        '<th class="prev"><i class="foundicon-left-arrow fi-arrow-left"/></th>' +
        '<th colspan="5" class="date-switch"></th>' +
        '<th class="next"><i class="foundicon-right-arrow fi-arrow-right"/></th>' +
        '</tr>' +
        '</thead>',
